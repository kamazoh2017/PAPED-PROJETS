/*
  ...
  - You are about to drop the column `tagStatut` on the `commentaires_taches` table. All the data in the column will be lost.
  - You are about to drop the column `motifStatut` on the `taches` table. All the data in the column will be lost.
